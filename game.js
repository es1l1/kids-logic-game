const GameData = {
    ...
    assets: {
        colors: [
            {n: "أخضر", i: "🌿", c: "#2ed573"}, {n: "أزرق", i: "💎", c: "#1e90ff"},
            {n: "أحمر", i: "🍎", c: "#ff4757"}, {n: "أصفر", i: "☀️", c: "#ffa502"},
            {n: "بنفسجي", i: "🍇", c: "#a29bfe"}, {n: "برتقالي", i: "🍊", c: "#ff7f50"}
        ],
        shapes: [
            {n: "مربع", i: "⬛", c: "#2f3542"}, {n: "دائرة", i: "⭕", c: "#5352ed"},
            {n: "نجمة", i: "⭐", c: "#ffa502"}, {n: "قلب", i: "❤️", c: "#ff6b81"},
            {n: "مثلث", i: "🔺", c: "#2ed573"}, {n: "قمر", i: "🌙", c: "#f1c40f"}
        ],
        animals: [
            {n: "أسد", i: "🦁", c: "#e67e22"}, {n: "باندا", i: "🐼", c: "#ced6e0"},
            {n: "فيل", i: "🐘", c: "#70a1ff"}, {n: "أرنب", i: "🐰", c: "#ffffff"},
            {n: "زرافة", i: "🦒", c: "#f1c40f"}, {n: "قرد", i: "🐒", c: "#a04000"}
        ],
        fruits: [
            {n: "موز", i: "🍌", c: "#eccc68"}, {n: "عنب", i: "🍇", c: "#a29bfe"},
            {n: "بطيخ", i: "🍉", c: "#ff6b81"}, {n: "كرز", i: "🍒", c: "#ff4757"},
            {n: "أناناس", i: "🍍", c: "#ffa502"}, {n: "كيوي", i: "🥝", c: "#2ed573"}
        ],
        numbers: [
